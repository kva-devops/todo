...
<head>
    <meta charset="UTF-8">
    <title>Приложение "ToDO" - Все задачи </title>
...
<div class="container-fluid">
    <h1>Все задачи</h1>
    <p> Все задачи, включая выполненные.</p>
</div>
...
<div class="container-fluid">
        <button type="submit" class="btn btn-primary mt-3" onclick="return showOpenTask()">Текущие задачи</button>
</div>
</body>
</html>
